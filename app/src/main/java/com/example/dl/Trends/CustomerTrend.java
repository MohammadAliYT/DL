...
import com.example.dl.Invoice.addInvoice;
...
public class CustomerTrend extends AppCompatActivity implements AdapterView.OnItemSelectedListener {

    //Variables
    Spinner customerSpinner;
    ArrayAdapter<String> adapter;
    ArrayList<String> customerSpinnerData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_trend);
        monthlySale();
        monthlySale1();
        ...
        chart1data = findViewById(R.id.customerData1);

        //Initializing Array
        customerSpinnerData = new ArrayList<>();
        adapter = new ArrayAdapter<String>(CustomerTrend.this, android.R.layout.simple_spinner_dropdown_item, customerSpinnerData);

        //Populating Spinner
        ArrayAdapter<CharSequence> customerName = ArrayAdapter.createFromResource(this, R.array.customers_name, android.R.layout.simple_spinner_item);
        customerName.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        customerSpinner.setAdapter(customerName);
